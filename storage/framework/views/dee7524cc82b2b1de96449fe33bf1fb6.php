...
init() {
  this.activeImage = this.images.length > 0 ? this.images[0] : null
        ...
        >
          <div class="relative">
           <template x-for="image in images">
              ...
              >
                <img src="<?php echo e(asset('uploads/' . $shopProducts[0]->image)); ?>" alt="" class="w-auto mx-auto"/>
              </div>
            </template>
            <a
              @click.prevent="prev"
      ...
      <div class="lg:col-span-2">
        ...
        <?php echo e($shopProducts[0]->Prod_Name); ?>

        </h1>
        <div class="text-xl font-bold mb-6">$ <?php echo e($shopProducts[0]->Price); ?></div>
        ...
        <button  data-productid="<?php echo e($shopProducts[0]->id); ?>"
        ...
        <div class="mb-6" x-data="{expanded: false}">
          ...
          >
            ...
            <p class="">
            <?php echo e($shopProducts[0]->Description); ?>
...
<main class="p-5">
      ...
      >
      <?php $__currentLoopData = $lataestProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        >
          <a href="<?php echo e(route('shopProduct', ['slug' => $product->slug])); ?>" class="block overflow-hidden">
...
<?php endif; ?>
          ...
          <div data-productname="<?php echo e($product->Prod_Name); ?>" class="p-4">
            <h3 class="text-lg">
              <a href="<?php echo e(route('shopProduct', ['slug' => $product->slug])); ?>">
              <?php echo e($product->Prod_Name); ?>

              </a>
            </h3>
            <h5 data-productprice="<?php echo e($product->Price); ?>" class="font-bold"> <?php echo e($product->Price); ?></h5>
          </div>
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u209708021/domains/weaverstore.net/public_html/resources/views/product.blade.php ENDPATH**/ ?>