...
<div class="container">
    ...
    <form role="form" action="<?php echo e(route('orderplace.data')); ?>" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="<?php echo e(env('STRIPE_KEY')); ?>" id="payment-form">
        <?php echo csrf_field(); ?>
                        ...
                        <div class="needs-validation" novalidate="">
                            <div class="row">
                                <div class="col-md-6 mb-3 pl-5">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo e(old('first_name')); ?>" name="first_name" id="firstName" placeholder="" value="">
                    ...
                    <div class="card-body">
                        <div class="needs-validation" novalidate="">
                            <div class="row">
                                <div class="col-md-6 mb-3 pl-5">
                                    <label for="firstName">First name</label>
                                    <input type="text" class="form-control" value="<?php echo e(old('ship_firstname')); ?>" name="ship_firstname" id="ship_firstName" placeholder="" value="">
                                    <div class="invalid-feedback">
                                    </div>
                                </div>
                                <div class="col-md-6 mb-3">
                    ...
                    <div class="card-body">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0">
                                Products:
                                <span>
                                    $ <?php echo e(number_format((float)$total, 2, '.', '')); ?> </span>
                            </li>
                            
                               <li class="list-group-item d-flex justify-content-between align-items-center border-0 px-0 pb-0">
                                Tax:
                                <span>
                                    $ <?php echo e(number_format((float)$totalrate, 2, '.', '')); ?> </span>
                            </li>
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                ...
                                <span><strong>
                                        $<?php echo e(number_format((float)$totalprice, 2, '.', '')); ?> </strong></span>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u209708021/domains/weaverstore.net/public_html/resources/views/checkout.blade.php ENDPATH**/ ?>