        ...
        <div class="bg-white p-3 rounded-md shadow-md">
          ...
          ?>
              <tr class="border-b">
                ...
                <td>
                <?php if($order->status) { ?>
                  <span class="bg-emerald-500 text-white p-1 rounded"><?php echo e($order->status?$order->status:'pending'); ?></span>
                  <?php } ?>
                </td>
                ...
                <td class="flex gap-3">
                  ...
                  <button class="btn-primary py-1 px-2 flex items-center">
                      <a href="<?php echo e(route('orderDetails.view', $order->id)); ?>">
                      View</a> </button>
                  </button>
                </td>
              </tr>
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u209708021/domains/weaverstore.net/public_html/resources/views/orders.blade.php ENDPATH**/ ?>