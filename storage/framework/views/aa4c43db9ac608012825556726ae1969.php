...
<main class="p-5">
      ...
      <div class="container lg:w-2/3 xl:w-2/3 mx-auto">
        <h1 class="text-3xl font-bold mb-6">Order # <?php echo e($orderdetails->id); ?> Details</h1>
                ...
                <tr>
                  ...
                  <td>
                    <span class="bg-emerald-500 text-white p-1 rounded"
                      ><?php echo e($orderdetails->status); ?></span
                    >
                  </td>
                </tr>
                <tr>
          ...
          ?>
            ...
            <div class="flex gap-6">
              ...
              <div class="flex flex-col justify-between items-end pb-3 w-32">
                <div class="text-lg mb-4">$ <?php echo e($productdata->Price * $order->product_qty); ?></div>
              </div>
            </div>
            <!--/ Product Item -->
            <hr class="my-2" />
...
<?php echo $__env->make('partials.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/akshay/ecommerceProject/resources/views/order-details.blade.php ENDPATH**/ ?>